...
//        String cmd = "export LD_PRELOAD=/home/sunyiwen/Desktop/S2Rtracing/REPTrace/libhook.so";
...
//        }
        ...
        if (isConsumer) {
            ...
            String processID = getProcessId().toString();
            ...
            String filePath = "/home/sunyiwen/Desktop/S2Rtracing/beforeMethod.txt";
            File f = new File(filePath);
            OutputStream fOut = new FileOutputStream(f);
            OutputStreamWriter writer = new OutputStreamWriter(fOut, "UTF-8");

//            String segmentID = TraceContext.getDefaultInstance().getTraceSegmentId();
            String segmentID = TraceContext.segmentId();
            if(segmentID == ""){
                segmentID = "0";
            }

//            String spanID =String.valueOf(TraceContext.getDefaultInstance().getSpanId());
            ...
            spanData spandata= new spanData(traceID,startTime);

            segmentData segmentdata = new segmentData(threadID,spanID,spandata);

            tracingData tracingdata = new tracingData(processID,segmentID,segmentdata);
            String data = tracingdata.toJson();

            writer.append(data);
            writer.close();
            fOut.write(data.getBytes().length);
            fOut.flush();
            fOut.close();
        }
...
//
//        String afterFilePath = "/home/sunyiwen/Desktop/S2Rtracing/afterMethod.txt";
//        File ff = new File(afterFilePath);
//        TIMES++;
//        OutputStream fOut = new FileOutputStream(ff);
//        OutputStreamWriter writer = new OutputStreamWriter(fOut, "UTF-8");
...
////        String traceStr = "{\"processID\":\"18107\",\"segmentID\":\"0\",\"segment\":{\"threadID\":\"103\",\"spanID\":\"0\",\"span\":{\"traceID\":\"0\",\"startTime\":\"2022-12-12 01:15:42\"}}}";
////        String traceLength =String.valueOf(traceStr.length());
//        tracingData data = tracingData.fromJson(traceStr);
//
//        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
//        String endTime = df.format(System.currentTimeMillis());
//
//        data.segment.span.endTime = endTime;
